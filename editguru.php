            ...
            <div class="container-fluid">                
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Edit Data Guru</h3>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form class="form-horizontal form-material" method="POST" action="updateguru.php">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="mapel" value="<?= $hasil['mapel'] ?>" class="form-control form-control-line">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
