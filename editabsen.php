<?php 
	...
	require 'config.php';
	$id = $_GET['id'];
    $sql = "select * from data_absen where id=?";
            ...
            <div class="container-fluid">                
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Edit Data Absen</h3>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form class="form-horizontal form-material" method="POST" action="updateabsen.php">
                                                <input type="hidden" name="id" value="<?= $hasil['id']?>">
                                                <div class="form-group">
                                                    <label class="col-md-12">Nama</label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="nama" value="<?= $hasil['nama'] ?>" class="form-control form-control-line">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-12">kehadiran</label>
                                                    <div class="col-md-12">
                                                        <input type="text" name="kehadiran" value="<?= $hasil['kehadiran'] ?>" class="form-control form-control-line">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-12">
