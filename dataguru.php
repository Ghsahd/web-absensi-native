                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div>
                                            <h3 class="card-title m-b-5"><span class="lstick"></span>Data Guru </h3>
                                        </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $isi['mapel']?></td>
                                                        <td>
                                                        <a href="deleteguru.php?id=<?php echo $isi['id'];?>" class="waves-effect waves-dark">
                                                            <i class="mdi mdi-delete-forever btn btn-danger"></i>
                                                        </a>

                                                        <a href="editguru.php?id=<?php echo $isi['id'];?>" class="waves-effect waves-dark">
                                                    ...
                                                    <div class="modal-content mt-5">
                                                        ...
                                                        <div class="modal-body" id="mediumBody">
                                                            ...
                                                            <div class="col-lg-8 col-xlg-9 col-md-7">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <form class="form-horizontal form-material" method="POST" action="tambahguru.php">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <input type="text" name="mapel" class="form-control form-control-line">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
